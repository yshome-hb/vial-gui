...
KEYCODES_BASIC = [
    ...
    K(0xC0, "KC_FN0", "FN0", alias=["fn0"]),
    K(0xC1, "KC_FN1", "FN1", alias=["fn1"]),
    K(0xC2, "KC_FN2", "FN2", alias=["fn2"]),
    K(0xC3, "KC_FN3", "FN3", alias=["fn3"]),
    K(0xC4, "KC_FN4", "FN4", alias=["fn4"]),
    K(0xC5, "KC_FN5", "FN5", alias=["fn5"]),
    K(0xC6, "KC_FN6", "FN6", alias=["fn6"]),
    K(0xC7, "KC_FN7", "FN7", alias=["fn7"]),
    K(0xC8, "KC_FN8", "FN8", alias=["fn8"]),
    K(0xC9, "KC_FN9", "FN9", alias=["fn9"]),
    K(0xCA, "KC_FN10", "FN10", alias=["fn10"]),
    K(0xCB, "KC_FN11", "FN11", alias=["fn11"]),
    K(0xCC, "KC_FN12", "FN12", alias=["fn12"]),
    K(0xCD, "KC_FN13", "FN13", alias=["fn13"]),
    K(0xCE, "KC_FN14", "FN14", alias=["fn14"]),
    K(0xCF, "KC_FN15", "FN15", alias=["fn15"]),
    K(0xD0, "KC_FN16", "FN16", alias=["fn16"]),
    K(0xD1, "KC_FN17", "FN17", alias=["fn17"]),
    K(0xD2, "KC_FN18", "FN18", alias=["fn18"]),
    K(0xD3, "KC_FN19", "FN19", alias=["fn19"]),
    K(0xD4, "KC_FN20", "FN20", alias=["fn20"]),
    K(0xD5, "KC_FN21", "FN21", alias=["fn21"]),
    K(0xD6, "KC_FN22", "FN22", alias=["fn22"]),
    K(0xD7, "KC_FN23", "FN23", alias=["fn23"]),
    K(0xD8, "KC_FN24", "FN24", alias=["fn24"]),
    K(0xD9, "KC_FN25", "FN25", alias=["fn25"]),
    K(0xDA, "KC_FN26", "FN26", alias=["fn26"]),
    K(0xDB, "KC_FN27", "FN27", alias=["fn27"]),
    K(0xDC, "KC_FN28", "FN28", alias=["fn28"]),
    K(0xDD, "KC_FN29", "FN29", alias=["fn29"]),
    K(0xDE, "KC_FN30", "FN30", alias=["fn30"]),
